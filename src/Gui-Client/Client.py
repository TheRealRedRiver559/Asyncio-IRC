...
# Client needs an entire re write in a different lib, and also needs to be finished. 
# PySide6 / PyQT is not suitable for SSL and whatnot on top of Asyncio. 
        ...
        while self.tcp_socket.canReadLine():
            ...
            if message:
                ...
                if main_type == MessageType.INFO:
                    ...
                    if sub_type == MessageSubType.ACK:
                        message = Message(
                            sender=self.username,
                            message="Pong",
