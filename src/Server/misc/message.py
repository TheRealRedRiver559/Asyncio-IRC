...
import time
# TODO: Redo this entire message system . At the moment it is kind of terrible and does't make too much sense. 
# Need to add some sort of solid messaging system that anyone can expand upon.  Also need ot use ENUMS
class MessageType:
